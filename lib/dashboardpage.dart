 ...
 // 👈 give space below to prevent cutoff
  ...
  Widget _buildAttendanceCard() {
    return Container(
      ...
      // reducing the vertical padding of my attendance container
      ...
      child: Column(
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                    //  builder: (context) => GetAttendancePage(
       ...
       // const SizedBox(height: 3),
          ...
          const SizedBox(width: 12), // horizontal spacing, optional
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text("Today",
  ...
  //       children: [
  //         CircleAvatar(
  //           backgroundColor: isActive ? Colors.red : headerColor,
  //           radius: 28,
  ...
  return GestureDetector(
    onTap: () {
      ...
      if (label == "Manual Attendance") {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => AllowanceHistoryPage()));
      } else if (label == "Work From Home") {
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => WorkFromHistoryPage()));
      } else if (label == "Work on Holiday") {
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => WorkonHolidayHistoryPage()));
      }
    }, // <-- This closes the onTap function
    child: Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        CircleAvatar(
