...
Map<String, dynamic> toJson() {
  return {
    ...
    'le_time': le_time,
    'remarks': remarks,
    if (id != null) 'id': id, // ✅ safe null check, key is String
  };
}
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: const BorderSide(color: Color(0xFF346CB0)), // <-- update here
          ),
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Late In / Early Out + Official/Personal Work in one row
  ...
  children: [
    Text(
      ...
      style: const TextStyle(
        fontSize: 14,
        color: Colors.black87, // normal color like date/time/remarks
